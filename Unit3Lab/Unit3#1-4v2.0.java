...
//----------------------------------------------------------------------------------------------			
// 1)			
// Write  a method called recombine that returns a String created from its two String parameters as follows.
...
//----------------------------------------------------------------------------------------------	
// 4)
// Ask the user to input a sentence. Have the program output how many words are in the sentence. 
//	Then ask them which word to output (1st, 2nd, 3rd, etc) and output that word. 
//	If the selected number is more than the word count, make sure to let the user know. 
